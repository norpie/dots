...
create_autocmd('BufNewFile', { pattern = '*.tera', command = 'set filetype=htmldjango' })
create_autocmd('BufFilePre', { pattern = '*.tera', command = 'set filetype=htmldjango' })
create_autocmd('BufRead', { pattern = '*.tera', command = 'set filetype=htmldjango' })
