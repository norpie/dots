...
alias cm="ccm --plan max5 --timezone Europe/Brussels --time-format 24h"
...
alias dpl="dots pull --rebase --recurse-submodules && dots submodule update --init --recursive"
...
alias scp="scp -F $XDG_CONFIG_HOME/ssh/config -o UserKnownHostsFile=$HOME/.config/ssh/known_hosts"
